                ...
                <div className="mb-4 p-3 bg-gray-50 dark:bg-gray-800 rounded">
                  ...
                  {item.submission.status === "graded" && (
                    <div className="mt-2 border-t pt-2 border-gray-200 dark:border-gray-700">
                      <p className="text-sm">
                        <strong>Grade:</strong>{" "}
                        {item.submission.grade.points} / {item.assignment.maxPoints}
                      </p>
            ...
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-xl font-bold">
                  {selectedAssignment.submission ? "View Submission" : "Submit Assignment"}
                </h3>
                <button
              ...
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  <strong>Points:</strong> {selectedAssignment.assignment.maxPoints}
                </p>
              </div>
              ...
              {selectedAssignment.submission ? (
                <div>
                  <div className="mb-6">
                    <h4 className="font-bold mb-2">Submission Details</h4>
                    <p className="text-sm mb-2">
                      <strong>Submitted:</strong>{" "}
                      {new Date(
                    ...
                    <p className="text-sm mb-2">
                      ...
                      >
                        {selectedAssignment.submission.status.charAt(0).toUpperCase() +
                    ...
                    {selectedAssignment.submission.status === "graded" && (
                      <div className="mt-4 p-3 bg-gray-50 dark:bg-gray-800 rounded">
                        <h4 className="font-bold mb-2">Grade</h4>
                        <p className="text-sm mb-2">
                  ...
                  <div className="mb-6">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Files will be available to view here.
                    </p>
                  </div>
                ...
                <form onSubmit={handleSubmit}>
                  <div className="mb-6">
                    ...
                    <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                      Upload PDF, Word, Excel, PowerPoint, image files, or zip files.
                      Maximum 5 files, 50MB per file.
                    </p>
                  </div>
