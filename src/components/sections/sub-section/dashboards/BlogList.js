...
<option value="published"><TranslatedText>Publié</TranslatedText></option>
<option value="draft"><TranslatedText>Brouillon</TranslatedText></option>
<option value="archived"><TranslatedText>Archivé</TranslatedText></option>
          ...
          <div>
            <select
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
            >
<option value=""><TranslatedText>Toutes les catégories</TranslatedText></option>
<option value="Technology"><TranslatedText>Technologie</TranslatedText></option>
<option value="Education"><TranslatedText>Éducation</TranslatedText></option>
<option value="Business"><TranslatedText>Affaires</TranslatedText></option>
<option value="General"><TranslatedText>Général</TranslatedText></option>
<option value="Career"><TranslatedText>Carrière</TranslatedText></option>
<option value="Development"><TranslatedText>Développement</TranslatedText></option>
...
<option value="Productivity"><TranslatedText>Productivité</TranslatedText></option>
          ...
          <div>
            {selectedBlogs.length > 0 && (
              <button className="w-full px-3 py-2 bg-red-600 text-white rounded-md hover:bg-red-700">
                ...
                <TranslatedText>Supprimer la sélection</TranslatedText> ({selectedBlogs.length})
              </button>
            )}
          </div>
        </div>
