...
const BlogList = ({
  ...
  return (
    <div className="bg-white dark:bg-darkdeep1 rounded-lg shadow-md">
      {/* Filters */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div>
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-naveBlue dark:text-white"
            />
          </div>
          <div>
            <select
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          <thead className="bg-gray-50 dark:bg-darkdeep3-dark">
            <tr>
          ...
          <tbody className="bg-white dark:bg-darkdeep3-dark divide-y divide-gray-200 dark:divide-gray-700">
            {blogs.length === 0 ? (
              <tr>
                <td
                  colSpan="7"
              ...
              blogs.map((blog) => (
                <tr
                  key={blog._id}
                  className="hover:bg-gray-50 dark:hover:bg-darkdeep1"
                >
