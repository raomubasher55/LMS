  ...
  if (loading) {
    return (
      <div className="p-10px md:px-10 md:py-50px mb-30px bg-whiteColor dark:bg-whiteColor-dark shadow-accordion dark:shadow-accordion-dark rounded-5">
        <HeadingDashboard>Course Announcements</HeadingDashboard>
        ...
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-blackColor dark:text-blackColor-dark mb-2">
            {filter === 'unread' ? 'No unread announcements' : 
             filter === 'read' ? 'No read announcements' : 
             'No announcements yet'}
          </h3>
          <p className="text-contentColor dark:text-contentColor-dark">
            {filter === 'all' 
              ? "Your instructors will post course updates here. Make sure you're enrolled in courses to see announcements."
              : `Switch to "${filter === 'unread' ? 'All' : 'All'}" to see ${filter === 'unread' ? 'all' : 'all'} announcements.`
            }
          </p>
        </div>
      ) : (
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400 mb-3">
                      <span className="font-medium text-primaryColor">{announcement.courseId?.title}</span>
                      <span>•</span>
