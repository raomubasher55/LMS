      ...
      content: (
        loading ? (
          ...
          <div className="col-span-full text-center py-10">
            <p className="text-lg text-gray-500 dark:text-gray-400">You haven't enrolled in any courses yet.</p>
    ...
    },
    {
      ...
      content: (
        loading ? (
          ...
          <div className="col-span-full text-center py-10">
            <p className="text-lg text-gray-500 dark:text-gray-400">You don't have any active courses.</p>
          </div>
        )
      ),
    },
    {
      ...
      content: (
        loading ? (
          ...
          <div className="col-span-full text-center py-10">
            <p className="text-lg text-gray-500 dark:text-gray-400">You haven't completed any courses yet.</p>
          </div>
        )
      ),
    },
