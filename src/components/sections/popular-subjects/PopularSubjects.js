            ...
            <div className="relative">
              ...
              <div>
                ...
                <p className="text-sm md:text-base text-contentColor dark:text-contentColor-dark mb-10px 2xl:mb-50px">
                  <TranslatedText>
                    Chez Tanga Academie, nous vous proposons une sélection soignée de cours les mieux notés, créés par des instructeurs
                    experts, pour vous aider à garder une longueur
                    d’avance dans le monde compétitif d’aujourd’hui — accessibles à tout moment, partout.
                  </TranslatedText>
                ...
                <p className="text-sm md:text-base leading-7 text-contentColor dark:text-contentColor-dark mb-10 pl-3 border-l-[3px] border-secondaryColor">
                  <TranslatedText>
                    Que vous soyez intéressé par la technologie, les affaires, le design ou le développement personnel, nos cours —
                    comprenant des vidéos, des PDF, des quiz
                    et des devoirs — sont conçus pour vous transmettre des compétences concrètes qui comptent dans le monde réel.
                  </TranslatedText>
