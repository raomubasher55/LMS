...
const PopularSubjects = () => {
  ...
  const subjects = [
    {
      title: <TranslatedText>Études de commerce</TranslatedText>,
      desc: (
        <TranslatedText>
          L'étude des principes de gestion, de finance, et de marketing dans le
          monde des affaires.
        </TranslatedText>
      ),
      navButton: true,
            ...
            <div className="relative">
              ...
              <div>
                <span className="text-sm font-semibold text-primaryColor bg-whitegrey3 px-6 py-5px mb-5 rounded-full inline-block">
                  <TranslatedText>Cours populaires</TranslatedText>
                </span>
                <h3 className="text-3xl md:text-size-35 2xl:text-size-38 3xl:text-size-42 leading-10 md:leading-45px 2xl:leading-50px 3xl:leading-2xl font-bold text-blackColor dark:text-blackColor-dark pb-25px">
                  <TranslatedText>
                    Apprenez les compétences qui façonnent demain
                  </TranslatedText>
                </h3>
                <p className="text-sm md:text-base text-contentColor dark:text-contentColor-dark mb-10px 2xl:mb-50px">
                  <TranslatedText>
                    Chez Tanga Academie, nous vous proposons une sélection
                    soignée de cours les mieux notés, créés par des instructeurs
                    experts, pour vous aider à garder une longueur d’avance dans
                    le monde compétitif d’aujourd’hui — accessibles à tout
                    moment, partout.
                  </TranslatedText>
                </p>
                <p className="text-sm md:text-base leading-7 text-contentColor dark:text-contentColor-dark mb-10 pl-3 border-l-[3px] border-secondaryColor">
                  <TranslatedText>
                    Que vous soyez intéressé par la technologie, les affaires,
                    le design ou le développement personnel, nos cours —
                    comprenant des vidéos, des PDF, des quiz et des devoirs —
                    sont conçus pour vous transmettre des compétences concrètes
                    qui comptent dans le monde réel.
                  </TranslatedText>
                </p>

                <div>
                  <ButtonPrimary color="secondary" path="/courses">
                    <TranslatedText>Explorer davantage</TranslatedText>{" "}
