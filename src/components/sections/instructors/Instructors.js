  ...
  const instructors = [
    {
      ...
      image: aboutImage5,
      desc: "“Tanga Academie m’a donné la liberté de partager mes connaissances à l’échelle mondiale. Créer et vendre mes cours en ligne a été une expérience fluide et enrichissante.”",
    },
    {
      name: "Joseph Mbaga",
      desig: "Instructor - Web Development",
      image: aboutImage5,
      desc: "“La plateforme offre aux instructeurs d'excellents outils et une large base d'étudiants. J’ai pu entrer en contact avec des apprenants de différents pays grâce à mes cours.”",
    },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-15">
          ...
          >
            <div className="relative">
              <SectionName>
                <TranslatedText>
                  Voix des instructeurs
                </TranslatedText>
              </SectionName>
              <HeadingPrimary>
                <TranslatedText>
                  Ce que disent nos instructeurs
                </TranslatedText>

              </HeadingPrimary>
              <p className="text-sm md:text-base text-contentColor mt-5 mb-5 2xl:mb-45px dark:text-contentColor-dark">
              <TranslatedText>
                Tanga Academie permet aux instructeurs de créer, publier et vendre des cours dans tous 
                les domaines — de l’informatique et des affaires aux arts et au développement personnel.
              </TranslatedText>
              </p>
