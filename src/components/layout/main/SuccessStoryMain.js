  ...
  const studentStories = [
    {
      ...
      story: "From retail manager to full-stack developer in just 6 months! Tanga Academie's practical approach and mentorship made all the difference.",
  ...
  const instructorStories = [
    {
      ...
      story: "Teaching on Tanga Academie has allowed me to reach thousands of students globally and share my passion for AI.",
      earnings: "$50,000+",
      experience: "5 years"
    },
    {
      ...
      story: "Creating courses on Tanga Academie has been incredibly rewarding, both personally and financially.",
      earnings: "$35,000+",
      experience: "3 years"
    }
  ];
  ...
  const companyStories = [
    {
      ...
      story: "Tanga Academie's corporate training helped our team stay current with latest technologies.",
                        ...
                        <div className="text-center lg:text-left">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border border-blue-200 dark:border-blue-700/30">
                              <div className="text-lg sm:text-2xl font-bold text-blue dark:text-blue">{story.timeline}</div>
                              <div className="text-sm text-blue dark:text-blue">Timeline</div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="relative z-10 p-8">
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-6">
                        <div className=" dark:bg-blue/20 p-4 rounded-xl text-center border border-blue dark:border-blue/30">
                          <div className="text-lg sm:text-2xl font-bold text-blue dark:text-blue">{story.students}</div>
                          <div className="text-sm text-blue dark:text-blue/30">Students Taught</div>
                        </div>
                        <div className=" dark:bg-yellow/20 p-4 rounded-xl text-center border border-yellow dark:border-yellow/30">
                          <div className="text-lg sm:text-2xl font-bold text-yellow dark:text-yellow">{story.rating}</div>
                          <div className="text-sm text-yellow dark:text-yellow/30">Average Rating</div>
                        </div>
                        ...
                        <div className=" dark:bg-indigo/50 p-4 rounded-xl text-center border border-indigo dark:border-indigo/30">
                          <div className="text-lg sm:text-2xl font-bold text-indigo dark:text-white">{story.experience}</div>
                          <div className="text-sm text-indigo dark:text-white">Teaching</div>
                        </div>
                      </div>
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-purple-600 via-blue-600 to-green-600 p-12 text-center shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Join thousands of students, instructors, and companies who have transformed their careers and businesses with Tanga Academie.
              </p>
