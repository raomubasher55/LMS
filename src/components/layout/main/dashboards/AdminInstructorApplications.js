    ...
    <div className="p-4 md:p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-6 md:mb-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Instructor Applications</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-1 md:mt-2">Manage and review instructor applications</p>
          </div>
            ...
            <div className="divide-y divide-gray-200">
              {loading ? (
                ...
                <div className="p-6 md:p-8 text-center">
                  ...
                  <p className="text-gray-500 mt-3 md:mt-4 text-sm md:text-base">No applications found</p>
                </div>
              ) : (
                  ...
                  <div key={application._id} className="p-3 md:p-4 bg-opacity-50">
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="mt-2">
                          <p className="text-xs md:text-sm text-gray-600 dark:text-gray-300 font-medium">Expertise:</p>
          ...
          <div className=" rounded-lg shadow-sm border border-gray-200 sticky top-4">
            ...
            {selectedApplication ? (
              ...
              <div className="p-6 md:p-8 text-center">
                ...
                <p className="text-gray-500 mt-3 md:mt-4 text-sm md:text-base">Select an application to view details</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-4 md:p-6 w-full max-w-md">
            <div className="flex items-center justify-between mb-3 md:mb-4">
              <h3 className="text-lg font-semibold text-gray-900">Contact Instructor</h3>
              <button
                onClick={() => {
                  setShowContactModal(false);
                  setContactForm({ subject: '', message: '' });
