  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <header className="mb-12 text-center">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-8">Tanga Academy Policies</h1>
        
        {/* Tab Navigation */}
        <div className="flex justify-center mb-8">
          <div className="bg-naveBlue dark:bg-gray-600 p-1 rounded-lg inline-flex">
            <button
                ...
                <article className="group hover:scale-[1.02] transition-all duration-300">
                  <div className="flex items-start gap-4 p-6 rounded-2xl bg-gradient-to-r from-blue-50/50 to-indigo-50/50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200/30 dark:border-blue-400/20">
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 dark:text-gray-300 mb-4">When you use Tanga Academy, we collect:</p>
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mt-1">By using Tanga Academy, you agree to these terms</p>
                  </div>
                </div>
