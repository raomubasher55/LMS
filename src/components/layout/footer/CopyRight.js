        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-30px pt-10 items-center">
          ...
          <div className="lg:col-start-4 lg:col-span-6 text-center lg:text-left">
            <p className="text-whiteColor text-center">
              © 2025 <span className="text-primaryColor">Tanga Academy</span>. All Rights Reserved. <br />
              Developed by{" "}
              <a
                href="www.linkedin.com/in/zahid-ghotia"
                target="_blank"
              ...
              {[
                ...
                <li key={icon}>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 flex items-center justify-center text-whiteColor bg-whiteColor bg-opacity-10 hover:bg-primaryColor"
                  >
