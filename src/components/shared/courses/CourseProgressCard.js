      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <span className="text-xs bg-gray-100 dark:bg-gray-800 text-xs py-1 px-2 inline-block rounded ml-2">
              {language}
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center mb-2">
          <div className="w-8 h-8 rounded-full overflow-hidden relative mr-2">
            <Image
              src={instructor?.profile || "/default-avatar.png"}
              alt={instructor?.name}
              width={32}
              height={32}
              className="object-cover"
        ...
        <div className="flex justify-between text-sm text-gray-600 dark:text-gray-400 mb-3">
          ...
          <span>{Math.floor(totalDuration / 60)} mins</span>
        </div>
