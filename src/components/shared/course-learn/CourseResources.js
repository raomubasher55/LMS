            ...
            {course?.certificateFile ? (
              <div className="certificates-list space-y-3">
                {[{
                  ...
                  viewUrl: course.certificateFile?.startsWith('http') ? course.certificateFile : `${process.env.NEXT_PUBLIC_BACKEND_URL}${course.certificateFile}`,
                  downloadUrl: course.certificateFile?.startsWith('http') ? course.certificateFile : `${process.env.NEXT_PUBLIC_BACKEND_URL}${course.certificateFile}`,
