      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label htmlFor="title" className="block text-sm font-medium text-bodyColor dark:text-blackColor-dark mb-1">
            <TranslatedText>Titre du devoir</TranslatedText> *
          </label>
          <input
            type="text"
            id="title"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="dueDate" className="block text-sm font-medium text-bodyColor dark:text-blackColor-dark mb-1">
              <TranslatedText>Date limite</TranslatedText> *
            </label>
            <input
              type="datetime-local"
              id="dueDate"
          ...
          <div>
            <label htmlFor="maxPoints" className="block text-sm font-medium text-bodyColor dark:text-gray-400 mb-1">
              <TranslatedText>Points maximum</TranslatedText> *
            </label>
            <input
              type="number"
              id="maxPoints"
        ...
        <div>
          <label htmlFor="files" className="block text-sm font-medium text-bodyColor dark:text-blackColor-dark mb-1">
            <TranslatedText>Fichiers justificatifs</TranslatedText>
          </label>
          <input
            type="file"
            id="files"
        ...
        <div className="flex justify-end">
          ...
          >
            {isSubmitting ? <TranslatedText>Création en cours...</TranslatedText> : <TranslatedText>Créer le devoir</TranslatedText>}
          </button>
        </div>
      </form>
    </div>
