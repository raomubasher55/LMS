  ...
  const testimonials = [
    {
      ...
      desc: "Tanga Academy transformed my career. The HTML and CSS course gave me real-world skills and the confidence to build websites on my own.",
    },
    {
    ...
    },
    {
      ...
      desc: "Tanga Academy’s CSS module helped me master Flexbox and Grid. Perfect for designers who want frontend skills.",
    },
    {
      name: "Fatma Ally",
      icon: <UserIcon className="w-12 h-12 text-primary dark:text-white" />,
      desig: "Full-Stack Enthusiast",
      desc: "The structure and support at Tanga Academy are top-notch. I now have a strong foundation in web development.",
    },
    {
      name: "Samuel Mbwana",
      icon: <UserIcon className="w-12 h-12 text-primary dark:text-white" />,
    ...
    },
    {
      ...
      desc: "Tanga Academy helped me finally understand JavaScript. I now build interactive web apps confidently.",
    },
    {
      name: "Lucy Matonya",
      icon: <UserIcon className="w-12 h-12 text-primary dark:text-white" />,
    ...
    },
    {
      ...
      desc: "I improved my skills and got a remote job thanks to what I learned from Tanga Academy.",
    },
    {
      name: "Ruth Mbaga",
      icon: <UserIcon className="w-12 h-12 text-primary dark:text-white" />,
    ...
    },
    {
      ...
      desc: "I finally found a structured learning path at Tanga Academy. No fluff, just what matters.",
    },
    {
      name: "Mariam Juma",
      icon: <UserIcon className="w-12 h-12 text-primary dark:text-white" />,
    ...
    },
    {
      ...
      desc: "Learning at Tanga Academy was my first coding experience. Now I want to become a software engineer.",
    },
  ];
