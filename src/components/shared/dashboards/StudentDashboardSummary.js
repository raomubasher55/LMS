  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 flex flex-col">
        <h3 className="text-gray-500 dark:text-gray-400 text-sm uppercase font-semibold mb-2">Total Courses</h3>
      ...
      {/* Active Courses */}
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 flex flex-col">
        <h3 className="text-gray-500 dark:text-gray-400 text-sm uppercase font-semibold mb-2">Active Courses</h3>
        <div className="flex items-center">
          <span className="text-4xl font-bold text-gray-800 dark:text-white">
            {coursesLoading ? (
              <div className="h-10 w-16 bg-gray-200 dark:bg-gray-700 animate-pulse rounded"></div>
      ...
      {/* Completed Courses */}
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 flex flex-col">
        <h3 className="text-gray-500 dark:text-gray-400 text-sm uppercase font-semibold mb-2">Completed Courses</h3>
        <div className="flex items-center">
          <span className="text-4xl font-bold text-gray-800 dark:text-white">
            {coursesLoading ? (
              <div className="h-10 w-16 bg-gray-200 dark:bg-gray-700 animate-pulse rounded"></div>
      ...
      {/* Total Investment */}
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 flex flex-col">
        <h3 className="text-gray-500 dark:text-gray-400 text-sm uppercase font-semibold mb-2">Total Investment</h3>
        <div className="flex items-center">
          <span className="text-4xl font-bold text-gray-800 dark:text-white">
            {loading ? (
              <div className="h-10 w-16 bg-gray-200 dark:bg-gray-700 animate-pulse rounded"></div>
        ...
        <span className="mt-4 text-gray-600 dark:text-gray-400 text-sm">
          {stats.courseCount} Purchased Courses
        </span>
      </div>
    </div>
  );
