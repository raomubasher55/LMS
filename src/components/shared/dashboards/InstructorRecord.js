    ...
    <div className="overflow-auto">
      ...
      <table className="w-[550px] sm:w-full text-left">
        <thead className="text-sm md:text-base text-blackColor dark:text-blackColor-dark bg-lightGrey5 dark:bg-whiteColor-dark leading-1.8 md:leading-1.8">
          <tr className="w-full">
            <th className="px-5px py-10px md:px-5 w-[30%]">
              <TranslatedText>Nom</TranslatedText>
            </th>
            <th className="px-5px py-10px md:px-5 w-[25%]">
              <TranslatedText>Email</TranslatedText>
            </th>
            <th className="px-5px py-10px md:px-5 w-[20%]">
              <TranslatedText>Rôle</TranslatedText>
            </th>
            <th className="px-5px py-10px md:px-5 w-[25%]">
              <TranslatedText>Date d'inscription</TranslatedText>
            </th>
          </tr>
        </thead>
      </table>
